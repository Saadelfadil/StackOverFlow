...
const questions = [
    ...
    answers: [
      {
        _id: "201",
        content:
          "You can use the `cascade` option in SQLAlchemy relationships.",
      },
      { _id: "202", content: "Check the documentation for detailed examples." },
    ],
  ...
  },
  {
    ...
    answers: [
      {
        _id: "203",
        content: "You can use `margin: auto;` with a specified width.",
      },
      { _id: "204", content: "Flexbox and grid layout are also good options." },
    ],
    createdAt: new Date("2021-09-01T12:00:00.000Z"),
  },
