...
const popularTags = [
    {_id: 1, name: "javascript", totalQuestions},
    {_id: 2, name: "react", totalQuestions},
    {_id: 3, name: "nextjs", totalQuestions},
    {_id: 4, name: "tailwindcss", totalQuestions},
    {_id: 5, name: "typescript", totalQuestions},
]
